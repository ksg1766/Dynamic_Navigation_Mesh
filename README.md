...
# 📅 2024.08.07
📋 진행 사항
* AStar수행 시 반복적으로 수행되는 계산 횟수를 줄이기 위해 통로의 폭과 각도를 미리 계산해 저장하도록 변경했습니다.
  * 같은 경로에서 약 30% 정도의 속도 향상이 있었습니다.
...
⚽ 이후 계획
  * 오늘은 우선 3D navigation mesh 생성 작업부터 마무리할 계획입니다. 이후 경로 탐색 기능을 확장해보도록 하겠습니다.
